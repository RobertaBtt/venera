...
<script src="<?php echo get_template_directory_uri(); ?>/assets/js/jquery-1.8.3.min.js" type="text/javascript"></script>
<script src="<?php echo get_template_directory_uri(); ?>/assets/js/bootstrap.js" type="text/javascript"></script>
<script src="<?php echo get_template_directory_uri(); ?>/assets/js/prettify.js" type="text/javascript"></script>
<script src="<?php echo get_template_directory_uri(); ?>/assets/js/lightbox.js" type="text/javascript"></script>
