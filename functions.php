...
/**
 * Venera only works in WordPress 4.4 or later.
 */
 ...
 *
 * Create your own venera_setup() function to override in a child theme.
 *
 * @since Venera
 */
function venera_setup() {
	...
	add_image_size( 'venera-full-width', 1038, 576, true );
	// This theme uses wp_nav_menu() in two locations.
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'venera' ),
		'social'  => __( 'Social Links Menu', 'venera' ),
	) );
